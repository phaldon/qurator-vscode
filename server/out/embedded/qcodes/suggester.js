...
class QcodesSuggester {
    ...
    calculateCandidates(parser, caretPosition) {
        ...
        core.ignoredTokens = new Set([
            qcodeLexer_1.qcodeLexer.RBRACE,
            qcodeLexer_1.qcodeLexer.RBRACK,
            qcodeLexer_1.qcodeLexer.LBRACE,
            qcodeLexer_1.qcodeLexer.LBRACK,
            qcodeLexer_1.qcodeLexer.LPAREN,
            qcodeLexer_1.qcodeLexer.RPAREN,
            qcodeLexer_1.qcodeLexer.SEMI
        ]);
...
exports.QcodesSuggester = QcodesSuggester;
class SymbolsDictionary {
    constructor() {
        this.symbols = [
            ...
            {
                label: 'qvec',
                detail: 'Vector of qubits.',
                documentation: 'Vector of qubits.',
                type: 'QVEC',
                parent: 'QCODES',
                data: {
                    languageId: 'qcodes'
            ...
            {
                label: 'cvec',
                detail: 'Vector of classic bits.',
                documentation: 'Vector of classic bits.',
                type: 'CVEC',
                parent: 'QCODES',
                data: {
                    languageId: 'qcodes'
