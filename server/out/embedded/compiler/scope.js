...
class Scope {
    constructor(parentScope, name, startLine = 1, endLine = MAX_LINE, args = null, types = null) {
    ...
    lookupList(symbolName, line = MAX_LINE) {
        let symbol = this.searchInScope(symbolName, line);
        if (symbol) {
            return symbol;
        }
